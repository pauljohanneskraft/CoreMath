    ...
    private func setupViews() {
        ...
        addArrangedSubviewsWithoutResizingMask([
            NSStackView(orientation: .horizontal, alignment: .width, distribution: .fill, subviews: [
                NSTextField(string: "start:", textColor: .black), startTextField
            ]),
            NSStackView(orientation: .horizontal, alignment: .width, distribution: .fill, subviews: [
                NSTextField(string: "end:", textColor: .black), endTextField
            ]),
            NSStackView(orientation: .horizontal, alignment: .width, distribution: .fill, subviews: [
                NSTextField(string: "count:", textColor: .black), countTextField
            ])
        ])
    }
