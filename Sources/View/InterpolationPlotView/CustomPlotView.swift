...
class CustomInterpolationPlotView: NSView {
    ...
    func setConstraints() {
        ...
        let outerStackView = NSStackView(orientation: .vertical, alignment: .height,
                                         distribution: .gravityAreas, subviews: [innerStackView])
        ...
        outerStackView.addArrangedSubviewWithoutResizingMask(plotView)
        outerStackView.backgroundColor = .black
